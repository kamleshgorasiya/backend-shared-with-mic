...
export type GetShareRewardsInput = {
...
export type NoActiveCustomerError = ErrorResult & {
  __typename?: 'NoActiveCustomerError';
  errorCode: ErrorCode;
  message: Scalars['String'];
};
...
export type Query = {
  ...
  facets: FacetList;
  getCustomerShareRewards: UserShareResults;
  ...
  shareTimeSeries: ShareTimeSeries;
  shares: ShareList;
};
...
export type QueryGetCustomerShareRewardsArgs = {
  input?: InputMaybe<GetShareRewardsInput>;
};
...
export type QueryShareTimeSeriesArgs = {
  id: Scalars['ID'];
};
...
export type RequestCustomerSmsOtpResult = NoActiveCustomerError | PhoneNumberInvalidError | Success;
...
export type ShareTimeSeries = {
  __typename?: 'ShareTimeSeries';
  timeseries: Array<Maybe<SharePrice>>;
};
...
export type UserShareResults = {
  __typename?: 'UserShareResults';
  items?: Maybe<Array<Maybe<UserTotalShareResult>>>;
  totalCount?: Maybe<Scalars['Int']>;
};

export type UserTotalShareResult = {
  __typename?: 'UserTotalShareResult';
  name?: Maybe<Scalars['String']>;
  price?: Maybe<Scalars['String']>;
  ticker?: Maybe<Scalars['String']>;
  totalqty?: Maybe<Scalars['String']>;
};
...
export type VerifyCustomerSmsOtpResult = Customer | NoActiveCustomerError | PhoneNumberInvalidError | SmsOtpExpiredError | SmsOtpInvalidError;
