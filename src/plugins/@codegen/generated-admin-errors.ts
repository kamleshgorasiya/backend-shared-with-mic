...
export class NoActiveCustomerError extends ErrorResult {
  readonly __typename = 'NoActiveCustomerError';
  readonly errorCode = 'NO_ACTIVE_CUSTOMER_ERROR' as any;
  readonly message = 'NO_ACTIVE_CUSTOMER_ERROR';
  constructor(
  ) {
    super();
  }
