...
export declare function getAnimationTarget(hostEl: Element, targetSelector?: string): Element;
export declare function getAnimationKeyframesOrPropertyIndexedFrames(animationConfig: AnimationKeyframes | PropertyIndexedKeyframes, hostEl: Element): AnimationKeyframes | PropertyIndexedKeyframes;
