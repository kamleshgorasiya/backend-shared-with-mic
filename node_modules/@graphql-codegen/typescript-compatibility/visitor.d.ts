...
export declare class CompatibilityPluginVisitor extends BaseVisitor<CompatibilityPluginRawConfig, CompatibilityPluginConfig> {
    private _schema;
    constructor(rawConfig: CompatibilityPluginRawConfig, _schema: GraphQLSchema, options: {
        reactApollo: any;
    });
