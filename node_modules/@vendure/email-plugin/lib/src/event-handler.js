...
class EmailEventHandler {
    ...
    async handle(event, globals = {}, injector) {
        ...
        try {
            attachmentsArray = (_b = (await ((_a = this.setAttachmentsFn) === null || _a === void 0 ? void 0 : _a.call(this, event)))) !== null && _b !== void 0 ? _b : [];
        }
        catch (e) {
        ...
        const optionalAddressFields = (_d = (await ((_c = this.setOptionalAddressFieldsFn) === null || _c === void 0 ? void 0 : _c.call(this, event)))) !== null && _d !== void 0 ? _d : {};
