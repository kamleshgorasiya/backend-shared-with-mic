...
export declare class DropdownMenuComponent implements AfterViewInit, OnInit, OnDestroy {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<DropdownMenuComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<DropdownMenuComponent, "vdr-dropdown-menu", never, { "position": "vdrPosition"; }, {}, never, ["*"]>;
}
