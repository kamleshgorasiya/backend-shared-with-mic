...
export declare class ConfigurableInputComponent implements OnChanges, OnDestroy, ControlValueAccessor, Validator {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<ConfigurableInputComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<ConfigurableInputComponent, "vdr-configurable-input", never, { "readonly": "readonly"; "removable": "removable"; "operation": "operation"; "operationDefinition": "operationDefinition"; }, { "remove": "remove"; }, never, never>;
}

//# sourceMappingURL=configurable-input.component.d.ts.map