...
export declare class OrderResolver {
    ...
    constructor(orderService: OrderService, shippingMethodService: ShippingMethodService);
    orders(ctx: RequestContext, args: QueryOrdersArgs): Promise<PaginatedList<Order>>;
