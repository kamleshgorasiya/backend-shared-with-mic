...
function moveToIndex(index, target, siblings) {
    ...
    let currentIndex = siblings.findIndex(sibling => utils_1.idsAreEqual(sibling.id, target.id));
    ...
    currentIndex = siblingsWithTarget.findIndex(sibling => utils_1.idsAreEqual(sibling.id, target.id));
