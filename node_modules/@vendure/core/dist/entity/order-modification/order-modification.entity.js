...
__decorate([
    typeorm_1.ManyToOne(type => order_entity_1.Order, order => order.modifications, { onDelete: 'CASCADE' }),
    __metadata("design:type", order_entity_1.Order)
], OrderModification.prototype, "order", void 0);
__decorate([
    typeorm_1.ManyToMany(type => order_item_entity_1.OrderItem),
    typeorm_1.JoinTable(),
    __metadata("design:type", Array)
], OrderModification.prototype, "orderItems", void 0);
__decorate([
    typeorm_1.OneToMany(type => surcharge_entity_1.Surcharge, surcharge => surcharge.orderModification),
    __metadata("design:type", Array)
...
__decorate([
    typeorm_1.OneToOne(type => refund_entity_1.Refund),
    typeorm_1.JoinColumn(),
