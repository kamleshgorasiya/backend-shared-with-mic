...
__decorate([
    typeorm_1.OneToMany(type => product_variant_asset_entity_1.ProductVariantAsset, productVariantAsset => productVariantAsset.productVariant, {
        onDelete: 'SET NULL',
    }),
...
__decorate([
    typeorm_1.OneToMany(type => product_variant_price_entity_1.ProductVariantPrice, price => price.variant, { eager: true }),
    __metadata("design:type", Array)
], ProductVariant.prototype, "productVariantPrices", void 0);
__decorate([
    typeorm_1.OneToMany(type => product_variant_translation_entity_1.ProductVariantTranslation, translation => translation.base, { eager: true }),
    __metadata("design:type", Array)
], ProductVariant.prototype, "translations", void 0);
__decorate([
    typeorm_1.ManyToOne(type => product_entity_1.Product, product => product.variants),
...
__decorate([
    typeorm_1.Column({ default: 0 }),
    __metadata("design:type", Number)
], ProductVariant.prototype, "stockAllocated", void 0);
__decorate([
    typeorm_1.Column({ default: 0 }),
    __metadata("design:type", Number)
...
__decorate([
    typeorm_1.Column({ type: 'varchar', default: generated_types_1.GlobalFlag.INHERIT }),
    __metadata("design:type", String)
], ProductVariant.prototype, "trackInventory", void 0);
__decorate([
    typeorm_1.OneToMany(type => stock_movement_entity_1.StockMovement, stockMovement => stockMovement.productVariant),
    __metadata("design:type", Array)
], ProductVariant.prototype, "stockMovements", void 0);
__decorate([
    typeorm_1.ManyToMany(type => product_option_entity_1.ProductOption),
    typeorm_1.JoinTable(),
    __metadata("design:type", Array)
], ProductVariant.prototype, "options", void 0);
__decorate([
    typeorm_1.ManyToMany(type => facet_value_entity_1.FacetValue),
    typeorm_1.JoinTable(),
    __metadata("design:type", Array)
], ProductVariant.prototype, "facetValues", void 0);
__decorate([
    typeorm_1.Column(type => custom_entity_fields_1.CustomProductVariantFields),
    __metadata("design:type", custom_entity_fields_1.CustomProductVariantFields)
], ProductVariant.prototype, "customFields", void 0);
__decorate([
    typeorm_1.ManyToMany(type => collection_entity_1.Collection, collection => collection.productVariants),
    __metadata("design:type", Array)
