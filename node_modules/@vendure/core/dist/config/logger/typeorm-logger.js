...
class TypeOrmLogger {
    ...
    logQuerySlow(time, query, parameters, queryRunner) {
        ...
        vendure_logger_1.Logger.warn(`Execution time: ` + time);
    }
    ...
    formatQueryWithParams(query, parameters) {
        return query + ((parameters === null || parameters === void 0 ? void 0 : parameters.length) ? ' -- PARAMETERS: ' + this.stringifyParams(parameters) : '');
    }
    /**
