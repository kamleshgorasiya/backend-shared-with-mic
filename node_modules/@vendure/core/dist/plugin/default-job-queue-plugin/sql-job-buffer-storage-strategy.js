...
class SqlJobBufferStorageStrategy {
    ...
    async add(bufferId, job) {
        await this.connection.getRepository(job_record_buffer_entity_1.JobRecordBuffer).save(new job_record_buffer_entity_1.JobRecordBuffer({
            bufferId,
    ...
    async flush(bufferIds) {
        const selectQb = this.connection.getRepository(job_record_buffer_entity_1.JobRecordBuffer).createQueryBuilder('record');
        if (bufferIds === null || bufferIds === void 0 ? void 0 : bufferIds.length) {
