            ...
            try {
                ...
                for (let i = runningJobsCount; i < this.jobQueueStrategy.concurrency; i++) {
                    ...
                    if (nextJob) {
                        ...
                        const cancellationSignal$ = rxjs_1.interval(this.pollInterval * 5).pipe(operators_1.switchMap(() => this.jobQueueStrategy.findOne(nextJob.id)), operators_1.filter(job => (job === null || job === void 0 ? void 0 : job.state) === generated_types_1.JobState.CANCELLED), operators_1.take(1));
