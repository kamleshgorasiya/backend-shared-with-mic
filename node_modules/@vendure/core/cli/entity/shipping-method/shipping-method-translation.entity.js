...
__decorate([
    typeorm_1.ManyToOne(type => shipping_method_entity_1.ShippingMethod, base => base.translations),
    __metadata("design:type", shipping_method_entity_1.ShippingMethod)
], ShippingMethodTranslation.prototype, "base", void 0);
__decorate([
    typeorm_1.Column(type => custom_entity_fields_1.CustomShippingMethodFieldsTranslation),
...
ShippingMethodTranslation = __decorate([
    typeorm_1.Entity(),
