...
__decorate([
    typeorm_1.ManyToOne(type => product_option_group_entity_1.ProductOptionGroup, base => base.translations),
...
__decorate([
    typeorm_1.Column(type => custom_entity_fields_1.CustomProductOptionGroupFieldsTranslation),
