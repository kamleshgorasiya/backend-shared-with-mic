...
export declare function populateInitialData(app: INestApplicationContext, initialData: import('@vendure/core').InitialData, loggingFn?: (message: string) => void, channel?: import('@vendure/core').Channel): Promise<void>;
export declare function populateCollections(app: INestApplicationContext, initialData: import('@vendure/core').InitialData, loggingFn?: (message: string) => void, channel?: import('@vendure/core').Channel): Promise<void>;
