...
class FlowProducer extends events_1.EventEmitter {
    ...
    addNode({ multi, node, parent, queuesOpts }) {
        ...
        const jobId = utils_1.jobIdForGroup(node.opts, node.data, queueOpts) || uuid_1.v4();
        ...
        const parentKey = utils_1.getParentKey(parent === null || parent === void 0 ? void 0 : parent.parentOpts);
