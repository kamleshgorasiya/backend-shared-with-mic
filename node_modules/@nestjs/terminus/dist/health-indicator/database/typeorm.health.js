...
let TypeOrmHealthIndicator = class TypeOrmHealthIndicator extends __1.HealthIndicator {
    ...
    checkDependantPackages() {
        utils_1.checkPackages(['@nestjs/typeorm', 'typeorm'], this.constructor.name);
    }
    /**
     * Returns the connection of the current DI context
     */
    getContextConnection() {
        const { getConnectionToken, } = require('@nestjs/typeorm/dist/common/typeorm.utils');
        try {
    ...
    checkMongoDBConnection(connection) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                ...
                driver.mongodb.MongoClient.connect(connection.options.url ? connection.options.url : driver.buildConnectionUrl(connection.options), driver.buildConnectionOptions(connection.options), (err, client) => {
                    if (err)
                        return reject(new errors_1.MongoConnectionError(err.message));
    ...
    pingDb(connection, timeout) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield utils_1.promiseTimeout(timeout, check);
        });
    }
    /**
