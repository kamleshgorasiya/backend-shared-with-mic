...
let MicroserviceHealthIndicator = class MicroserviceHealthIndicator extends __1.HealthIndicator {
    ...
    checkDependantPackages() {
        this.nestJsMicroservices = utils_1.checkPackages(['@nestjs/microservices'], this.constructor.name)[0];
    }
    ...
    pingCheck(key, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield utils_1.promiseTimeout(timeout, this.pingMicroservice(options));
                isHealthy = true;
            }
            catch (err) {
