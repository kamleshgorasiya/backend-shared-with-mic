...
let GRPCHealthIndicator = class GRPCHealthIndicator extends health_indicator_1.HealthIndicator {
    ...
    checkDependantPackages() {
        this.nestJsMicroservices = utils_1.checkPackages(['@nestjs/microservices', 'grpc', '@grpc/proto-loader'], this.constructor.name)[0];
    }
    /**
    ...
    checkService(key, service, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const defaultOptions = {
                ...
                protoPath: path_1.join(__dirname, './protos/health.proto'),
            ...
            let response;
            try {
                response = yield utils_1.promiseTimeout(settings.timeout, settings.healthServiceCheck(healthService, service));
            }
            catch (err) {
